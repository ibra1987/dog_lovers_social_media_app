    ...
    <section className='w-full flex flex-col justify-center items-center mt-36 '>
       ...
       <h1 className='w-full my-2 text-center font-extrabold tracking-wide text-2xl md:text-4xl lg:text-6xl text-gray-500'>Where Dog Lovers Unite</h1>
        ...
        <h2 className='w-2/5 flex justify-center items-center text-2xl my-4 font-bold'>
             <span className='text-orange-400'>Woof </span><span className='text-xs mx-2'><FaPaw/></span>{" "}
             <span className='text-emerald-400'>Connect</span><span className='text-xs mx-2'><FaPaw/></span>{" "}
      ...
      <Link href={"/join"} className='text-center text-xl w-4/5 md:w-1/5 my-6 p-4 text-white font-bold rounded bg-blue-500  border border-white hover:border-blue-500 transition duration-200 cursor-pointer '>
